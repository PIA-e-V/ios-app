...
let appTitle = "FollowTheVote"
let webAppUrl = URL(string: "https://app.followthevote.com")
let allowedOrigin = "followthevote.com"
...
let navigationBarColor = getColorFromHex(hex: 0x343E94, alpha: 1.0)
let navigationTitleColor = getColorFromHex(hex: 0xFFFFFF, alpha: 1.0)
let navigationButtonColor = navigationTitleColor
let progressBarColor = getColorFromHex(hex: 0x343E94, alpha: 1.0)
